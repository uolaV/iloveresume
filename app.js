...
const T = {
  ...
  ru: {
    ...
    step_exp: 'Опыт',
    step_edu: 'Образование',
    step_skills: 'Навыки',
    step_extras: 'Дополнительно',
    ...
    add_skill_group: 'Добавить категорию',
    add_certification: 'Добавить',
    add_language: 'Добавить язык',
    certifications: 'Сертификаты',
    languages: 'Языки',
    interests: 'Интересы',
    interests_placeholder: 'Путешествия, Фотография, Спорт… (через запятую)',
    design_options: 'Дизайн & Настройки',
    template: 'Шаблон',
    tpl_modern: 'Современный',
    tpl_classic: 'Классический',
    tpl_bold: 'Жирный',
    tpl_compact: 'Компактный',
    ...
    save_json: 'Сохранить',
    import_json: 'Импорт',
    saved_json: 'Резюме сохранено ✓',
    imported_json: 'Резюме импортировано ✓',
    import_error: 'Неверный файл',
    persist_tip: 'Сохраните резюме в JSON, чтобы вернуться к нему и редактировать позже.',
    history_empty: 'История пуста',
    share_title: 'Поделиться резюме',
    share_desc: 'Эта ссылка содержит все данные. Никакие данные не отправляются на сервер.',
    ...
    description: 'Описание / Ключевые пункты (по одному на строку)',
    school: 'Школа / Университет',
    degree: 'Степень',
    field: 'Специальность',
    grade: 'Оценка',
    skill_category: 'Категория (напр. Языки, Инструменты…)',
    skill_items: 'Навыки (через запятую)',
    cert_name: 'Название сертификата',
    cert_issuer: 'Издатель',
    cert_date: 'Дата',
    lang_name: 'Язык',
    lang_level: 'Уровень (напр. Родной, B2)',
    load: 'Загрузить',
    ...
    demo_title: 'Примерные данные',
    demo_desc: 'замените своими',
    demo_clear: 'Очистить всё',
    projects: 'Проекты',
    ...
    add_volunteer: 'Добавить волонтёрский опыт',
    volunteer_org: 'Организация',
    volunteer_role: 'Роль',
    custom_section: 'Пользовательский раздел',
    add_custom_section: 'Добавить раздел',
    custom_section_title: 'Заголовок раздела',
    custom_entry_title: 'Заголовок',
    custom_entry_subtitle: 'Подзаголовок',
    custom_entry_date: 'Дата',
    custom_entry_desc: 'Описание',
    add_custom_entry: 'Добавить запись',
    saved_indicator: 'Сохранено',
    preview_cv: 'Просмотреть резюме',
    tpl_executive: 'Руководительский',
    tpl_creative: 'Творческий',
    tpl_technical: 'Технический',
    tpl_minimal: 'Минимальный',
    tpl_academic: 'Академический',
    tpl_infographic: 'Инфографика',
    tpl_elegant: 'Элегантный',
    tpl_twopage: 'Две страницы',
    publications: 'Публикации',
    add_publication: 'Добавить публикацию',
    pub_title: 'Заглавие',
    pub_authors: 'Авторы',
    pub_venue: 'Журнал / Конференция',
    pub_date: 'Дата',
    pub_url: 'URL',
    references: 'Рекомендации',
    add_reference: 'Добавить рекомендацию',
    ref_name: 'Имя',
    ref_title: 'Должность',
    ref_company: 'Компания',
    ref_email: 'Email',
    ref_phone: 'Телефон',
    references_available: 'Рекомендации по запросу',
    ats_checker: 'ATS оценка',
    ats_paste_job: 'Вставьте описание вакансии здесь',
    ats_analyze: 'Анализировать',
    ats_score: 'Оценка',
    ats_suggestions: 'Рекомендации',
    ats_matched: 'Найденные ключевые слова',
    ats_missing: 'Отсутствующие ключевые слова',
    ats_add_keywords: 'Добавьте эти ключевые слова в резюме',
    ats_add_section: 'Добавьте или заполните раздел',
    ats_sec_summary: 'Профессиональное резюме',
    ats_sec_experience: 'Опыт работы',
    ats_sec_skills: 'Навыки',
    ats_sec_education: 'Образование',
    ats_sec_header: 'Имя и должность',
    ats_fmt_chars: 'Удалите спецсимволы — ATS может не распознать их',
    ats_fmt_date: 'Используйте единый формат даты (YYYY-MM)',
    ats_fmt_summary_long: 'Сократите резюме (макс. 500 символов)',
    ats_fmt_summary_short: 'Расширьте резюме (мин. 30 символов)',
    ats_fmt_bullet: 'Сократите пункты (макс. 200 символов)',
    ats_fmt_few: 'Добавьте больше пунктов в опыт',
    ats_fmt_contact: 'Добавьте email или номер телефона',
    content_helpers: 'Помощь в написании',
    action_verbs: 'Глаголы действия',
    bullet_templates: 'Шаблоны пунктов',
    weak_words_detected: 'Обнаружены слабые слова',
    download_docx: 'Скачать DOCX',
    drag_hint: 'Перетащите для сортировки',
    font_size: 'Размер шрифта',
    spacing: 'Отступ',
    sidebar_width: 'Ширина панели',
  ...
  uk: {
    ...
    add_skill_group: 'Додати категорію',
    add_certification: 'Додати',
    add_language: 'Додати мову',
    certifications: 'Сертифікати',
    languages: 'Мови',
    interests: 'Інтереси',
    interests_placeholder: 'Подорожі, Фотографія, Спорт… (через кому)',
    design_options: 'Дизайн & Налаштування',
    template: 'Шаблон',
    tpl_modern: 'Сучасний',
    tpl_classic: 'Класичний',
    tpl_bold: 'Жирний',
    tpl_compact: 'Компактний',
    ...
    save_json: 'Зберегти',
    import_json: 'Імпорт',
    saved_json: 'Резюме збережено ✓',
    imported_json: 'Резюме імпортовано ✓',
    import_error: 'Невірний файл',
    persist_tip: 'Збережіть резюме у JSON, щоб повернутися до нього пізніше.',
    history_empty: 'Історія порожня',
    share_title: 'Поділитися резюме',
    share_desc: 'Це посилання містить усі дані. Жодні дані не надсилаються на сервер.',
    copy_link: 'Копіювати',
    ...
    description: 'Опис / Ключові пункти (по одному на рядок)',
    school: 'Школа / Університет',
    degree: 'Ступінь',
    field: 'Спеціальність',
    grade: 'Оцінка',
    skill_category: 'Категорія (напр. Мови, Інструменти…)',
    skill_items: 'Навички (через кому)',
    cert_name: 'Назва сертифіката',
    cert_issuer: 'Видавець',
    cert_date: 'Дата',
    lang_name: 'Мова',
    lang_level: 'Рівень (напр. Рідна, B2)',
    load: 'Завантажити',
    duplicate: 'Дублювати',
    delete: 'Видалити',
    pdf_generating: 'Створення PDF…',
    pdf_done: 'PDF завантажено!',
    present: 'Зараз',
    unnamed: 'Без назви',
    demo_title: 'Приклад даних',
    demo_desc: 'замініть своїми',
    demo_clear: 'Очистити все',
    projects: 'Проєкти',
    add_project: 'Додати проєкт',
    project_name: 'Назва проєкту',
    project_description: 'Опис',
    project_url: 'URL проєкту',
    project_tech: 'Використані технології',
    volunteer: 'Волонтерство',
    add_volunteer: 'Додати волонтерський досвід',
    volunteer_org: 'Організація',
    volunteer_role: 'Роль',
    custom_section: 'Довільний розділ',
    add_custom_section: 'Додати розділ',
    custom_section_title: 'Заголовок розділу',
    custom_entry_title: 'Заголовок',
    custom_entry_subtitle: 'Підзаголовок',
    custom_entry_date: 'Дата',
    custom_entry_desc: 'Опис',
    add_custom_entry: 'Додати запис',
    saved_indicator: 'Збережено',
    preview_cv: 'Переглянути резюме',
    tpl_executive: 'Керівний',
    tpl_creative: 'Творчий',
    tpl_technical: 'Технічний',
    tpl_minimal: 'Мінімальний',
    tpl_academic: 'Академічний',
    tpl_infographic: 'Інфографіка',
    tpl_elegant: 'Елегантний',
    tpl_twopage: 'Дві сторінки',
    publications: 'Публікації',
    add_publication: 'Додати публікацію',
    pub_title: 'Заголовок',
    pub_authors: 'Автори',
    pub_venue: 'Журнал / Конференція',
    pub_date: 'Дата',
    pub_url: 'URL',
    references: 'Рекомендації',
    add_reference: 'Додати рекомендацію',
    ref_name: 'Ім\'я',
    ref_title: 'Посада',
    ref_company: 'Компанія',
    ref_email: 'Email',
    ref_phone: 'Телефон',
    references_available: 'Рекомендації на запит',
    ats_checker: 'ATS оцінка',
    ats_paste_job: 'Вставте опис вакансії тут',
    ats_analyze: 'Аналізувати',
    ats_score: 'Оцінка',
    ats_suggestions: 'Рекомендації',
    ats_matched: 'Знайдені ключові слова',
    ats_missing: 'Відсутні ключові слова',
    ats_add_keywords: 'Додайте ці ключові слова до резюме',
    ats_add_section: 'Додайте або заповніть розділ',
    ats_sec_summary: 'Професійне резюме',
    ats_sec_experience: 'Досвід роботи',
    ats_sec_skills: 'Навички',
    ats_sec_education: 'Освіта',
    ats_sec_header: 'Ім\'я та посада',
    ats_fmt_chars: 'Видаліть спецсимволи — ATS може не розпізнати їх',
    ats_fmt_date: 'Використовуйте єдиний формат дати (YYYY-MM)',
    ats_fmt_summary_long: 'Скоротіть резюме (макс. 500 символів)',
    ats_fmt_summary_short: 'Розширте резюме (мін. 30 символів)',
    ats_fmt_bullet: 'Скоротіть пункти (макс. 200 символів)',
    ats_fmt_few: 'Додайте більше пунктів до досвіду',
    ats_fmt_contact: 'Додайте email або номер телефону',
    content_helpers: 'Допомога у написанні',
    action_verbs: 'Дієслова дії',
    bullet_templates: 'Шаблони пунктів',
    weak_words_detected: 'Виявлені слабкі слова',
    download_docx: 'Завантажити DOCX',
    drag_hint: 'Перетягніть для сортування',
    font_size: 'Розмір шрифту',
    spacing: 'Відступ',
    sidebar_width: 'Ширина панелі',
  ...
  sv: {
    ...
    add_skill_group: 'Lägg till kategori',
    add_certification: 'Lägg till',
    add_language: 'Lägg till språk',
    certifications: 'Certifieringar',
    languages: 'Språk',
    interests: 'Intressen',
    interests_placeholder: 'Resor, Fotografi, Sport… (kommaseparerade)',
    design_options: 'Design & Alternativ',
    template: 'Mall',
    tpl_modern: 'Modern',
    tpl_classic: 'Klassisk',
    tpl_bold: 'Fet',
    tpl_compact: 'Kompakt',
    ...
    save_json: 'Spara',
    import_json: 'Importera',
    saved_json: 'CV sparat ✓',
    imported_json: 'CV importerat ✓',
    import_error: 'Ogiltig fil',
    persist_tip: 'Spara ditt CV som JSON för att hämta och uppdatera det senare.',
    history_empty: 'Inga CV i historiken',
    share_title: 'Dela ditt CV',
    share_desc: 'Den här länken innehåller all din data. Ingen data skickas till någon server.',
    copy_link: 'Kopiera',
    ...
    description: 'Beskrivning / Nyckelpunkter (en per rad)',
    school: 'Skola / Universitet',
    degree: 'Examen',
    field: 'Studieområde',
    grade: 'Betyg',
    skill_category: 'Kategori (t.ex. Språk, Verktyg…)',
    skill_items: 'Kompetenser (kommaseparerade)',
    cert_name: 'Certifieringsnamn',
    cert_issuer: 'Utfärdare',
    cert_date: 'Datum',
    lang_name: 'Språk',
    lang_level: 'Nivå (t.ex. Modersmål, B2)',
    load: 'Ladda',
    duplicate: 'Duplicera',
    delete: 'Ta bort',
    pdf_generating: 'Genererar PDF…',
    pdf_done: 'PDF nedladdad!',
    present: 'Nuvarande',
    unnamed: 'Namnlös',
    demo_title: 'Exempeldata',
    demo_desc: 'ersätt med dina egna',
    demo_clear: 'Rensa allt',
    projects: 'Projekt',
    add_project: 'Lägg till projekt',
    project_name: 'Projektnamn',
    project_description: 'Beskrivning',
    project_url: 'Projekt-URL',
    project_tech: 'Använda teknologier',
    volunteer: 'Volontärarbete',
    add_volunteer: 'Lägg till volontärerfarenhet',
    volunteer_org: 'Organisation',
    volunteer_role: 'Roll',
    custom_section: 'Anpassat avsnitt',
    add_custom_section: 'Lägg till avsnitt',
    custom_section_title: 'Avsnittsrubrik',
    custom_entry_title: 'Rubrik',
    custom_entry_subtitle: 'Underrubrik',
    custom_entry_date: 'Datum',
    custom_entry_desc: 'Beskrivning',
    add_custom_entry: 'Lägg till post',
    saved_indicator: 'Sparat',
    preview_cv: 'Förhandsgranska CV',
    tpl_executive: 'Executive',
    tpl_creative: 'Kreativ',
    tpl_technical: 'Teknisk',
    tpl_minimal: 'Minimal',
    tpl_academic: 'Akademisk',
    tpl_infographic: 'Infografik',
    tpl_elegant: 'Elegant',
    tpl_twopage: 'Två sidor',
    publications: 'Publikationer',
    add_publication: 'Lägg till publikation',
    pub_title: 'Titel',
    pub_authors: 'Författare',
    pub_venue: 'Tidskrift / Konferens',
    pub_date: 'Datum',
    pub_url: 'URL',
    references: 'Referenser',
    add_reference: 'Lägg till referens',
    ref_name: 'Namn',
    ref_title: 'Titel / Position',
    ref_company: 'Företag',
    ref_email: 'E-post',
    ref_phone: 'Telefon',
    references_available: 'Referenser tillgängliga på begäran',
    ats_checker: 'ATS-poäng',
    ats_paste_job: 'Klistra in jobbeskrivning här',
    ats_analyze: 'Analysera',
    ats_score: 'Poäng',
    ats_suggestions: 'Förslag',
    ats_matched: 'Matchade nyckelord',
    ats_missing: 'Saknade nyckelord',
    ats_add_keywords: 'Lägg till dessa nyckelord i ditt CV',
    ats_add_section: 'Lägg till eller komplettera avsnitt',
    ats_sec_summary: 'Professionell sammanfattning',
    ats_sec_experience: 'Arbetslivserfarenhet',
    ats_sec_skills: 'Kompetenser',
    ats_sec_education: 'Utbildning',
    ats_sec_header: 'Namn och jobbtitel',
    ats_fmt_chars: 'Ta bort specialtecken — ATS kanske inte kan läsa dem',
    ats_fmt_date: 'Använd konsekvent datumformat (YYYY-MM)',
    ats_fmt_summary_long: 'Förkorta din sammanfattning (max 500 tecken)',
    ats_fmt_summary_short: 'Utöka din sammanfattning (minst 30 tecken)',
    ats_fmt_bullet: 'Förkorta punkterna (max 200 tecken)',
    ats_fmt_few: 'Lägg till fler punkter i din erfarenhet',
    ats_fmt_contact: 'Lägg till e-post eller telefonnummer',
    content_helpers: 'Skrivhjälp',
    action_verbs: 'Aktionsverb',
    bullet_templates: 'Punktmallar',
    weak_words_detected: 'Svaga ord upptäckta',
    download_docx: 'Ladda ner DOCX',
    drag_hint: 'Dra för att sortera om',
    font_size: 'Teckenstorlek',
    spacing: 'Avstånd',
    sidebar_width: 'Sidofältsbredd',
    section_visibility: 'Synliga avsnitt',
  },
  da: {
    step_profile: 'Profil',
    step_exp: 'Erfaring',
    step_edu: 'Uddannelse',
    step_skills: 'Kompetencer',
    step_extras: 'Ekstra',
    ...
    add_skill_group: 'Tilføj kategori',
    add_certification: 'Tilføj',
    add_language: 'Tilføj sprog',
    certifications: 'Certificeringer',
    languages: 'Sprog',
    interests: 'Interesser',
    interests_placeholder: 'Rejser, Fotografi, Sport… (kommaseparerede)',
    design_options: 'Design & Indstillinger',
    template: 'Skabelon',
    tpl_modern: 'Moderne',
    tpl_classic: 'Klassisk',
    tpl_bold: 'Fed',
    ...
    saved_json: 'CV gemt ✓',
    imported_json: 'CV importeret ✓',
    import_error: 'Ugyldig fil',
    persist_tip: 'Gem dit CV som JSON for at hente og opdatere det senere.',
    history_empty: 'Ingen CV i historikken',
    share_title: 'Del dit CV',
    share_desc: 'Dette link indeholder alle dine data. Ingen data sendes til nogen server.',
    copy_link: 'Kopiér',
    link_copied: '✓ Link kopieret!',
    preview_placeholder: 'Udfyld formularen for at se dit CV',
    ...
    end_date: 'Slutdato',
    current_position: 'Nuværende stilling',
    description: 'Beskrivelse / Nøglepunkter (ét pr. linje)',
    school: 'Skole / Universitet',
    degree: 'Grad',
    field: 'Studieretning',
    grade: 'Karakter',
    skill_category: 'Kategori (f.eks. Sprog, Værktøjer…)',
    skill_items: 'Kompetencer (kommaseparerede)',
    cert_name: 'Certificeringsnavn',
    cert_issuer: 'Udsteder',
    cert_date: 'Dato',
    lang_name: 'Sprog',
    lang_level: 'Niveau (f.eks. Modersmål, B2)',
    load: 'Indlæs',
    duplicate: 'Dupliker',
    delete: 'Slet',
    pdf_generating: 'Genererer PDF…',
    pdf_done: 'PDF downloadet!',
    present: 'Nuværende',
    unnamed: 'Unavngivet',
    demo_title: 'Eksempeldata',
    demo_desc: 'erstat med dine egne',
    demo_clear: 'Ryd alt',
    projects: 'Projekter',
    ...
    project_url: 'Projekt-URL',
    project_tech: 'Anvendte teknologier',
    volunteer: 'Frivilligt arbejde',
    add_volunteer: 'Tilføj frivillig erfaring',
    volunteer_org: 'Organisation',
    volunteer_role: 'Rolle',
    custom_section: 'Brugerdefineret afsnit',
    add_custom_section: 'Tilføj afsnit',
    custom_section_title: 'Afsnitoverskrift',
    custom_entry_title: 'Titel',
    custom_entry_subtitle: 'Undertitel',
    custom_entry_date: 'Dato',
    custom_entry_desc: 'Beskrivelse',
    add_custom_entry: 'Tilføj post',
    saved_indicator: 'Gemt',
    preview_cv: 'Forhåndsvis CV',
    tpl_executive: 'Executive',
    tpl_creative: 'Kreativ',
    tpl_technical: 'Teknisk',
    tpl_minimal: 'Minimal',
    ...
    tpl_infographic: 'Infografik',
    tpl_elegant: 'Elegant',
    tpl_twopage: 'To sider',
    publications: 'Publikationer',
    add_publication: 'Tilføj publikation',
    pub_title: 'Titel',
    pub_authors: 'Forfattere',
    pub_venue: 'Tidsskrift / Konference',
    pub_date: 'Dato',
    pub_url: 'URL',
    references: 'Referencer',
    add_reference: 'Tilføj reference',
    ref_name: 'Navn',
    ref_title: 'Titel / Stilling',
    ref_company: 'Virksomhed',
    ref_email: 'E-mail',
    ref_phone: 'Telefon',
    references_available: 'Referencer tilgængelige på anmodning',
    ats_checker: 'ATS-score',
    ats_paste_job: 'Indsæt jobbeskrivelse her',
    ats_analyze: 'Analysér',
    ats_score: 'Score',
    ats_suggestions: 'Forslag',
    ats_matched: 'Matchede nøgleord',
    ats_missing: 'Manglende nøgleord',
    ats_add_keywords: 'Tilføj disse nøgleord til dit CV',
    ats_add_section: 'Tilføj eller udfyld afsnit',
    ats_sec_summary: 'Professionelt resumé',
    ats_sec_experience: 'Arbejdserfaring',
    ats_sec_skills: 'Kompetencer',
    ats_sec_education: 'Uddannelse',
    ats_sec_header: 'Navn og jobtitel',
    ats_fmt_chars: 'Fjern specialtegn — ATS kan muligvis ikke læse dem',
    ats_fmt_date: 'Brug konsekvent datoformat (YYYY-MM)',
    ats_fmt_summary_long: 'Forkort dit resumé (maks. 500 tegn)',
    ats_fmt_summary_short: 'Udvid dit resumé (min. 30 tegn)',
    ats_fmt_bullet: 'Forkort punkterne (maks. 200 tegn)',
    ats_fmt_few: 'Tilføj flere punkter til din erfaring',
    ats_fmt_contact: 'Tilføj e-mail eller telefonnummer',
    content_helpers: 'Skrivehjælp',
    action_verbs: 'Handlingsverber',
    bullet_templates: 'Punktskabeloner',
    weak_words_detected: 'Svage ord opdaget',
    download_docx: 'Download DOCX',
    drag_hint: 'Træk for at omarrangere',
    font_size: 'Skriftstørrelse',
    spacing: 'Afstand',
    sidebar_width: 'Sidebjælkebredde',
    section_visibility: 'Synlige afsnit',
  },
  no: {
    step_profile: 'Profil',
    step_exp: 'Erfaring',
    step_edu: 'Utdanning',
    step_skills: 'Ferdigheter',
    step_extras: 'Ekstra',
    ...
    add_skill_group: 'Legg til kategori',
    add_certification: 'Legg til',
    add_language: 'Legg til språk',
    certifications: 'Sertifiseringer',
    languages: 'Språk',
    interests: 'Interesser',
    interests_placeholder: 'Reiser, Fotografi, Sport… (kommaseparert)',
    design_options: 'Design & Alternativer',
    template: 'Mal',
    tpl_modern: 'Moderne',
    tpl_classic: 'Klassisk',
    tpl_bold: 'Fet',
    ...
    save_json: 'Lagre',
    import_json: 'Importer',
    saved_json: 'CV lagret ✓',
    imported_json: 'CV importert ✓',
    import_error: 'Ugyldig fil',
    persist_tip: 'Lagre CV-en din som JSON for å hente og oppdatere den senere.',
    history_empty: 'Ingen CV i historikken',
    share_title: 'Del CV-en din',
    share_desc: 'Denne lenken inneholder alle dataene dine. Ingen data sendes til noen server.',
    copy_link: 'Kopier',
    link_copied: '✓ Lenke kopiert!',
    preview_placeholder: 'Fyll ut skjemaet for å se CV-en din',
    ...
    start_date: 'Startdato',
    end_date: 'Sluttdato',
    current_position: 'Nåværende stilling',
    description: 'Beskrivelse / Nøkkelpunkter (ett per linje)',
    school: 'Skole / Universitet',
    degree: 'Grad',
    field: 'Studieretning',
    grade: 'Karakter',
    skill_category: 'Kategori (f.eks. Språk, Verktøy…)',
    skill_items: 'Ferdigheter (kommaseparert)',
    cert_name: 'Sertifiseringsnavn',
    cert_issuer: 'Utsteder',
    cert_date: 'Dato',
    lang_name: 'Språk',
    lang_level: 'Nivå (f.eks. Morsmål, B2)',
    load: 'Last inn',
    duplicate: 'Dupliser',
    delete: 'Slett',
    pdf_generating: 'Genererer PDF…',
    pdf_done: 'PDF lastet ned!',
    present: 'Nåværende',
    unnamed: 'Uten navn',
    demo_title: 'Eksempeldata',
    demo_desc: 'erstatt med dine egne',
    demo_clear: 'Tøm alt',
    projects: 'Prosjekter',
    ...
    project_tech: 'Brukte teknologier',
    volunteer: 'Frivillig arbeid',
    add_volunteer: 'Legg til frivillig erfaring',
    volunteer_org: 'Organisasjon',
    volunteer_role: 'Rolle',
    custom_section: 'Tilpasset seksjon',
    add_custom_section: 'Legg til seksjon',
    custom_section_title: 'Seksjonstittel',
    custom_entry_title: 'Tittel',
    custom_entry_subtitle: 'Undertittel',
    custom_entry_date: 'Dato',
    custom_entry_desc: 'Beskrivelse',
    add_custom_entry: 'Legg til oppføring',
    saved_indicator: 'Lagret',
    preview_cv: 'Forhåndsvis CV',
    tpl_executive: 'Executive',
    tpl_creative: 'Kreativ',
    tpl_technical: 'Teknisk',
    tpl_minimal: 'Minimal',
    tpl_academic: 'Akademisk',
    tpl_infographic: 'Infografikk',
    tpl_elegant: 'Elegant',
    tpl_twopage: 'To sider',
    publications: 'Publikasjoner',
    add_publication: 'Legg til publikasjon',
    pub_title: 'Tittel',
    pub_authors: 'Forfattere',
    pub_venue: 'Tidsskrift / Konferanse',
    pub_date: 'Dato',
    pub_url: 'URL',
    references: 'Referanser',
    add_reference: 'Legg til referanse',
    ref_name: 'Navn',
    ref_title: 'Tittel / Stilling',
    ref_company: 'Selskap',
    ref_email: 'E-post',
    ref_phone: 'Telefon',
    references_available: 'Referanser tilgjengelig på forespørsel',
    ats_checker: 'ATS-score',
    ats_paste_job: 'Lim inn jobbeskrivelse her',
    ats_analyze: 'Analyser',
    ats_score: 'Score',
    ats_suggestions: 'Forslag',
    ats_matched: 'Matchede nøkkelord',
    ats_missing: 'Manglende nøkkelord',
    ats_add_keywords: 'Legg til disse nøkkelordene i CV-en din',
    ats_add_section: 'Legg til eller fyll ut seksjon',
    ats_sec_summary: 'Profesjonelt sammendrag',
    ats_sec_experience: 'Arbeidserfaring',
    ats_sec_skills: 'Ferdigheter',
    ats_sec_education: 'Utdanning',
    ats_sec_header: 'Navn og jobbtittel',
    ats_fmt_chars: 'Fjern spesialtegn — ATS kan kanskje ikke lese dem',
    ats_fmt_date: 'Bruk konsekvent datoformat (YYYY-MM)',
    ats_fmt_summary_long: 'Forkort sammendraget (maks. 500 tegn)',
    ats_fmt_summary_short: 'Utvid sammendraget (min. 30 tegn)',
    ats_fmt_bullet: 'Forkort punktene (maks. 200 tegn)',
    ats_fmt_few: 'Legg til flere punkter i erfaringen din',
    ats_fmt_contact: 'Legg til e-post eller telefonnummer',
    content_helpers: 'Skrivehjelp',
    action_verbs: 'Handlingsverb',
    bullet_templates: 'Punktmaler',
    weak_words_detected: 'Svake ord oppdaget',
    download_docx: 'Last ned DOCX',
    drag_hint: 'Dra for å omordne',
    font_size: 'Skriftstørrelse',
    spacing: 'Avstand',
    sidebar_width: 'Sidefeltsbredde',
    ...
    add_skill_group: 'Lisää kategoria',
    add_certification: 'Lisää',
    add_language: 'Lisää kieli',
    certifications: 'Sertifikaatit',
    languages: 'Kielet',
    interests: 'Harrastukset',
    interests_placeholder: 'Matkailu, Valokuvaus, Urheilu… (pilkulla erotettuna)',
    design_options: 'Muotoilu & Asetukset',
    template: 'Malli',
    tpl_modern: 'Moderni',
    tpl_classic: 'Klassinen',
    tpl_bold: 'Lihavoitu',
    tpl_compact: 'Kompakti',
    ...
    save_json: 'Tallenna',
    import_json: 'Tuo',
    saved_json: 'CV tallennettu ✓',
    imported_json: 'CV tuotu ✓',
    import_error: 'Virheellinen tiedosto',
    persist_tip: 'Tallenna CV JSON-muodossa, jotta voit palata siihen ja muokata sitä myöhemmin.',
    history_empty: 'Ei CV:tä historiassa',
    share_title: 'Jaa CV',
    share_desc: 'Tämä linkki sisältää kaikki tietosi. Mitään tietoja ei lähetetä palvelimelle.',
    copy_link: 'Kopioi',
    link_copied: '✓ Linkki kopioitu!',
    preview_placeholder: 'Täytä lomake nähdäksesi CV:si',
    ...
    current_position: 'Nykyinen tehtävä',
    description: 'Kuvaus / Avainkohdat (yksi per rivi)',
    school: 'Koulu / Yliopisto',
    degree: 'Tutkinto',
    field: 'Opiskeluala',
    grade: 'Arvosana',
    skill_category: 'Kategoria (esim. Kielet, Työkalut…)',
    skill_items: 'Taidot (pilkulla erotettuna)',
    cert_name: 'Sertifikaatin nimi',
    cert_issuer: 'Myöntäjä',
    cert_date: 'Päivämäärä',
    lang_name: 'Kieli',
    lang_level: 'Taso (esim. Äidinkieli, B2)',
    load: 'Lataa',
    duplicate: 'Kopioi',
    delete: 'Poista',
    pdf_generating: 'Luodaan PDF…',
    pdf_done: 'PDF ladattu!',
    present: 'Nykyinen',
    unnamed: 'Nimetön',
    demo_title: 'Esimerkkitiedot',
    demo_desc: 'korvaa omillasi',
    demo_clear: 'Tyhjennä kaikki',
    projects: 'Projektit',
    add_project: 'Lisää projekti',
    project_name: 'Projektin nimi',
    project_description: 'Kuvaus',
    project_url: 'Projektin URL',
    project_tech: 'Käytetyt teknologiat',
    volunteer: 'Vapaaehtoistyö',
    add_volunteer: 'Lisää vapaaehtoiskokemus',
    volunteer_org: 'Organisaatio',
    volunteer_role: 'Rooli',
    custom_section: 'Mukautettu osio',
    add_custom_section: 'Lisää osio',
    custom_section_title: 'Osion otsikko',
    custom_entry_title: 'Otsikko',
    custom_entry_subtitle: 'Alaotsikko',
    custom_entry_date: 'Päivämäärä',
    custom_entry_desc: 'Kuvaus',
    add_custom_entry: 'Lisää merkintä',
    saved_indicator: 'Tallennettu',
    preview_cv: 'Esikatsele CV',
    tpl_executive: 'Johtaja',
    tpl_creative: 'Luova',
    tpl_technical: 'Tekninen',
    tpl_minimal: 'Minimaalinen',
    tpl_academic: 'Akateeminen',
    tpl_infographic: 'Infografia',
    tpl_elegant: 'Tyylikäs',
    tpl_twopage: 'Kaksi sivua',
    publications: 'Julkaisut',
    add_publication: 'Lisää julkaisu',
    pub_title: 'Otsikko',
    pub_authors: 'Tekijät',
    pub_venue: 'Lehti / Konferenssi',
    pub_date: 'Päivämäärä',
    pub_url: 'URL',
    references: 'Suositukset',
    add_reference: 'Lisää suositus',
    ref_name: 'Nimi',
    ref_title: 'Nimike / Tehtävä',
    ref_company: 'Yritys',
    ref_email: 'Sähköposti',
    ref_phone: 'Puhelin',
    references_available: 'Suositukset saatavilla pyydettäessä',
    ats_checker: 'ATS-pisteet',
    ats_paste_job: 'Liitä työnkuvaus tähän',
    ats_analyze: 'Analysoi',
    ats_score: 'Pisteet',
    ats_suggestions: 'Ehdotukset',
    ats_matched: 'Löydetyt avainsanat',
    ats_missing: 'Puuttuvat avainsanat',
    ats_add_keywords: 'Lisää nämä avainsanat CV:hön',
    ats_add_section: 'Lisää tai täytä osio',
    ats_sec_summary: 'Ammatillinen yhteenveto',
    ats_sec_experience: 'Työkokemus',
    ats_sec_skills: 'Taidot',
    ats_sec_education: 'Koulutus',
    ats_sec_header: 'Nimi ja tehtävänimike',
    ats_fmt_chars: 'Poista erikoismerkit — ATS ei välttämättä pysty lukemaan niitä',
    ats_fmt_date: 'Käytä yhtenäistä päivämäärämuotoa (YYYY-MM)',
    ats_fmt_summary_long: 'Lyhennä yhteenvetoa (maks. 500 merkkiä)',
    ats_fmt_summary_short: 'Laajenna yhteenvetoa (väh. 30 merkkiä)',
    ats_fmt_bullet: 'Lyhennä luettelomerkkejä (maks. 200 merkkiä)',
    ats_fmt_few: 'Lisää enemmän kohtia kokemukseesi',
    ats_fmt_contact: 'Lisää sähköposti tai puhelinnumero',
    content_helpers: 'Kirjoitusapu',
    action_verbs: 'Toimintaverbit',
    bullet_templates: 'Luettelomerkkimallit',
    weak_words_detected: 'Heikot sanat havaittu',
    download_docx: 'Lataa DOCX',
    drag_hint: 'Vedä järjestääksesi uudelleen',
    font_size: 'Kirjasinkoko',
    spacing: 'Välistys',
    sidebar_width: 'Sivupalkin leveys',
  ...
  ro: {
    ...
    step_exp: 'Experiență',
    step_edu: 'Educație',
    step_skills: 'Competențe',
    step_extras: 'Extra',
    full_name: 'Nume complet *',
    job_title: 'Titlu / Poziție *',
    summary: 'Rezumat',
    phone: 'Telefon',
    city: 'Oraș / Țară',
    website: 'Site web',
    ...
    add_experience: 'Adaugă experiență',
    add_education: 'Adaugă educație',
    add_skill_group: 'Adaugă categorie',
    add_certification: 'Adaugă',
    ...
    save_json: 'Salvează',
    import_json: 'Importă',
    saved_json: 'CV salvat ✓',
    imported_json: 'CV importat ✓',
    import_error: 'Fișier invalid',
    persist_tip: 'Salvați CV-ul ca JSON pentru a-l recupera și actualiza mai târziu.',
    history_empty: 'Niciun CV în istoric',
    share_title: 'Partajează CV-ul tău',
    share_desc: 'Acest link conține toate datele tale. Nicio dată nu este trimisă pe server.',
    copy_link: 'Copiază',
    link_copied: '✓ Link copiat!',
    preview_placeholder: 'Completați formularul pentru a vedea CV-ul',
    ...
    current_position: 'Poziție actuală',
    description: 'Descriere / Puncte cheie (unul pe linie)',
    school: 'Școală / Universitate',
    degree: 'Diplomă',
    field: 'Domeniu de studiu',
    grade: 'Notă',
    skill_category: 'Categorie (ex: Limbaje, Instrumente…)',
    skill_items: 'Competențe (separate prin virgulă)',
    cert_name: 'Denumire certificare',
    cert_issuer: 'Emitent',
    cert_date: 'Dată',
    lang_name: 'Limbă',
    lang_level: 'Nivel (ex: Nativ, B2)',
    load: 'Încarcă',
    duplicate: 'Duplică',
    delete: 'Șterge',
    pdf_generating: 'Se generează PDF…',
    pdf_done: 'PDF descărcat!',
    present: 'Prezent',
    unnamed: 'Fără titlu',
    demo_title: 'Date exemplu',
    demo_desc: 'înlocuiți cu ale dvs.',
    demo_clear: 'Șterge tot',
    projects: 'Proiecte',
    add_project: 'Adaugă proiect',
    project_name: 'Numele proiectului',
    project_description: 'Descriere',
    project_url: 'URL proiect',
    project_tech: 'Tehnologii utilizate',
    volunteer: 'Voluntariat',
    add_volunteer: 'Adaugă experiență de voluntariat',
    volunteer_org: 'Organizație',
    volunteer_role: 'Rol',
    custom_section: 'Secțiune personalizată',
    add_custom_section: 'Adaugă secțiune personalizată',
    custom_section_title: 'Titlul secțiunii',
    custom_entry_title: 'Titlu',
    custom_entry_subtitle: 'Subtitlu',
    custom_entry_date: 'Dată',
    custom_entry_desc: 'Descriere',
    add_custom_entry: 'Adaugă intrare',
    saved_indicator: 'Salvat',
    preview_cv: 'Previzualizează CV',
    tpl_executive: 'Executive',
    tpl_creative: 'Creativ',
    tpl_technical: 'Tehnic',
    tpl_minimal: 'Minimal',
    tpl_academic: 'Academic',
    tpl_infographic: 'Infografic',
    tpl_elegant: 'Elegant',
    tpl_twopage: 'Două pagini',
    publications: 'Publicații',
    add_publication: 'Adaugă publicație',
    pub_title: 'Titlu',
    pub_authors: 'Autori',
    pub_venue: 'Revistă / Conferință',
    pub_date: 'Dată',
    pub_url: 'URL',
    references: 'Referințe',
    add_reference: 'Adaugă referință',
    ref_name: 'Nume',
    ref_title: 'Titlu / Poziție',
    ref_company: 'Companie',
    ref_email: 'Email',
    ref_phone: 'Telefon',
    references_available: 'Referințe disponibile la cerere',
    ats_checker: 'Scor ATS',
    ats_paste_job: 'Lipiți descrierea postului aici',
    ats_analyze: 'Analizează',
    ats_score: 'Scor',
    ats_suggestions: 'Sugestii',
    ats_matched: 'Cuvinte cheie găsite',
    ats_missing: 'Cuvinte cheie lipsă',
    ats_add_keywords: 'Adăugați aceste cuvinte cheie în CV',
    ats_add_section: 'Adăugați sau completați secțiunea',
    ats_sec_summary: 'Rezumat profesional',
    ats_sec_experience: 'Experiență de muncă',
    ats_sec_skills: 'Competențe',
    ats_sec_education: 'Educație',
    ats_sec_header: 'Nume și titlu',
    ats_fmt_chars: 'Eliminați caracterele speciale — ATS poate să nu le citească',
    ats_fmt_date: 'Utilizați un format de dată consistent (YYYY-MM)',
    ats_fmt_summary_long: 'Scurtați rezumatul (max. 500 caractere)',
    ats_fmt_summary_short: 'Extindeți rezumatul (min. 30 caractere)',
    ats_fmt_bullet: 'Scurtați punctele (max. 200 caractere)',
    ats_fmt_few: 'Adăugați mai multe puncte la experiența dvs.',
    ats_fmt_contact: 'Adăugați email sau număr de telefon',
    content_helpers: 'Ajutor la redactare',
    action_verbs: 'Verbe de acțiune',
    bullet_templates: 'Șabloane de puncte',
    weak_words_detected: 'Cuvinte slabe detectate',
    download_docx: 'Descarcă DOCX',
    drag_hint: 'Trageți pentru a reordona',
    font_size: 'Dimensiune font',
    spacing: 'Spațiere',
    sidebar_width: 'Lățime bară laterală',
    section_visibility: 'Secțiuni vizibile',
  },
  hu: {
    step_profile: 'Profil',
    step_exp: 'Tapasztalat',
    step_edu: 'Képzettség',
    step_skills: 'Készségek',
    step_extras: 'Egyéb',
    ...
    add_education: 'Képzettség hozzáadása',
    add_skill_group: 'Kategória hozzáadása',
    add_certification: 'Hozzáadás',
    add_language: 'Nyelv hozzáadása',
    certifications: 'Tanúsítványok',
    languages: 'Nyelvek',
    interests: 'Érdeklődési körök',
    interests_placeholder: 'Utazás, Fotózás, Sport… (vesszővel elválasztva)',
    design_options: 'Design & Beállítások',
    template: 'Sablon',
    tpl_modern: 'Modern',
    tpl_classic: 'Klasszikus',
    tpl_bold: 'Félkövér',
    tpl_compact: 'Kompakt',
    ...
    save_json: 'Mentés',
    import_json: 'Importálás',
    saved_json: 'CV mentve ✓',
    imported_json: 'CV importálva ✓',
    import_error: 'Érvénytelen fájl',
    persist_tip: 'Mentse el önéletrajzát JSON formátumban, hogy később visszatérhessen hozzá.',
    history_empty: 'Nincs önéletrajz az előzményekben',
    share_title: 'Önéletrajz megosztása',
    share_desc: 'Ez a link tartalmazza az összes adatát. Semmilyen adat nem kerül szerverre.',
    copy_link: 'Másolás',
    ...
    current_position: 'Jelenlegi pozíció',
    description: 'Leírás / Főbb pontok (soronként egy)',
    school: 'Iskola / Egyetem',
    degree: 'Végzettség',
    field: 'Szakterület',
    grade: 'Jegy',
    skill_category: 'Kategória (pl. Nyelvek, Eszközök…)',
    skill_items: 'Készségek (vesszővel elválasztva)',
    cert_name: 'Tanúsítvány neve',
    cert_issuer: 'Kibocsátó',
    cert_date: 'Dátum',
    lang_name: 'Nyelv',
    lang_level: 'Szint (pl. Anyanyelv, B2)',
    load: 'Betöltés',
    duplicate: 'Másolás',
    delete: 'Törlés',
    pdf_generating: 'PDF létrehozása…',
    pdf_done: 'PDF letöltve!',
    present: 'Jelenlegi',
    unnamed: 'Névtelen',
    demo_title: 'Minta adatok',
    demo_desc: 'cserélje le saját adataira',
    demo_clear: 'Összes törlése',
    projects: 'Projektek',
    add_project: 'Projekt hozzáadása',
    project_name: 'Projekt neve',
    project_description: 'Leírás',
    project_url: 'Projekt URL',
    project_tech: 'Használt technológiák',
    volunteer: 'Önkéntes munka',
    add_volunteer: 'Önkéntes tapasztalat hozzáadása',
    volunteer_org: 'Szervezet',
    volunteer_role: 'Szerep',
    custom_section: 'Egyéni szakasz',
    add_custom_section: 'Egyéni szakasz hozzáadása',
    custom_section_title: 'Szakasz címe',
    custom_entry_title: 'Cím',
    custom_entry_subtitle: 'Alcím',
    custom_entry_date: 'Dátum',
    custom_entry_desc: 'Leírás',
    add_custom_entry: 'Bejegyzés hozzáadása',
    saved_indicator: 'Mentve',
    preview_cv: 'Önéletrajz előnézete',
    tpl_executive: 'Vezető',
    tpl_creative: 'Kreatív',
    tpl_technical: 'Műszaki',
    tpl_minimal: 'Minimális',
    tpl_academic: 'Akadémiai',
    tpl_infographic: 'Infografika',
    tpl_elegant: 'Elegáns',
    tpl_twopage: 'Két oldal',
    publications: 'Publikációk',
    add_publication: 'Publikáció hozzáadása',
    pub_title: 'Cím',
    pub_authors: 'Szerzők',
    pub_venue: 'Folyóirat / Konferencia',
    pub_date: 'Dátum',
    pub_url: 'URL',
    references: 'Referenciák',
    add_reference: 'Referencia hozzáadása',
    ref_name: 'Név',
    ref_title: 'Cím / Pozíció',
    ref_company: 'Vállalat',
    ref_email: 'Email',
    ref_phone: 'Telefon',
    references_available: 'Referenciák kérésre rendelkezésre állnak',
    ats_checker: 'ATS pontszám',
    ats_paste_job: 'Illessze be az álláshirdetést ide',
    ats_analyze: 'Elemzés',
    ats_score: 'Pontszám',
    ats_suggestions: 'Javaslatok',
    ats_matched: 'Talált kulcsszavak',
    ats_missing: 'Hiányzó kulcsszavak',
    ats_add_keywords: 'Adja hozzá ezeket a kulcsszavakat az önéletrajzhoz',
    ats_add_section: 'Adja hozzá vagy töltse ki a szakaszt',
    ats_sec_summary: 'Szakmai összefoglalás',
    ats_sec_experience: 'Munkatapasztalat',
    ats_sec_skills: 'Készségek',
    ats_sec_education: 'Képzettség',
    ats_sec_header: 'Név és munkakör',
    ats_fmt_chars: 'Távolítsa el a speciális karaktereket — az ATS esetleg nem tudja olvasni',
    ats_fmt_date: 'Használjon egységes dátumformátumot (YYYY-MM)',
    ats_fmt_summary_long: 'Rövidítse az összefoglalást (max. 500 karakter)',
    ats_fmt_summary_short: 'Bővítse az összefoglalást (min. 30 karakter)',
    ats_fmt_bullet: 'Rövidítse a felsoroláspontokat (max. 200 karakter)',
    ats_fmt_few: 'Adjon hozzá több pontot a tapasztalathoz',
    ats_fmt_contact: 'Adjon hozzá emailt vagy telefonszámot',
    content_helpers: 'Írási segítség',
    action_verbs: 'Cselekvő igék',
    bullet_templates: 'Felsoroláspont sablonok',
    weak_words_detected: 'Gyenge szavak észlelve',
    download_docx: 'DOCX letöltése',
    drag_hint: 'Húzza az átrendezéshez',
    font_size: 'Betűméret',
    spacing: 'Térköz',
    sidebar_width: 'Oldalsáv szélessége',
    section_visibility: 'Látható szakaszok',
  },
  cs: {
    step_profile: 'Profil',
    step_exp: 'Zkušenosti',
    step_edu: 'Vzdělání',
    step_skills: 'Dovednosti',
    step_extras: 'Ostatní',
    ...
    add_skill_group: 'Přidat kategorii',
    add_certification: 'Přidat',
    add_language: 'Přidat jazyk',
    certifications: 'Certifikáty',
    languages: 'Jazyky',
    interests: 'Zájmy',
    interests_placeholder: 'Cestování, Fotografie, Sport… (oddělené čárkou)',
    design_options: 'Design & Možnosti',
    template: 'Šablona',
    tpl_modern: 'Moderní',
    tpl_classic: 'Klasický',
    tpl_bold: 'Tučný',
    tpl_compact: 'Kompaktní',
    accent_color: 'Barva zvýraznění',
    font: 'Písmo',
    show_photo: 'Zobrazit fotografii v životopisu',
    previous: '← Předchozí',
    next: 'Další →',
    history: 'Historie',
    share: 'Sdílet',
    ...
    save_json: 'Uložit',
    import_json: 'Importovat',
    saved_json: 'CV uloženo ✓',
    imported_json: 'CV importováno ✓',
    import_error: 'Neplatný soubor',
    persist_tip: 'Uložte svůj životopis jako JSON, abyste se k němu mohli vrátit a upravit jej později.',
    history_empty: 'Žádné CV v historii',
    share_title: 'Sdílet životopis',
    share_desc: 'Tento odkaz obsahuje všechna vaše data. Žádná data nejsou odesílána na server.',
    copy_link: 'Kopírovat',
    ...
    description: 'Popis / Klíčové body (jeden na řádek)',
    school: 'Škola / Univerzita',
    degree: 'Titul',
    field: 'Obor studia',
    grade: 'Hodnocení',
    skill_category: 'Kategorie (např. Jazyky, Nástroje…)',
    skill_items: 'Dovednosti (oddělené čárkou)',
    cert_name: 'Název certifikátu',
    cert_issuer: 'Vydavatel',
    cert_date: 'Datum',
    lang_name: 'Jazyk',
    lang_level: 'Úroveň (např. Rodilý mluvčí, B2)',
    load: 'Načíst',
    ...
    present: 'Současnost',
    unnamed: 'Bez názvu',
    demo_title: 'Ukázková data',
    demo_desc: 'nahraďte svými',
    demo_clear: 'Vymazat vše',
    projects: 'Projekty',
    add_project: 'Přidat projekt',
    project_name: 'Název projektu',
    project_description: 'Popis',
    project_url: 'URL projektu',
    project_tech: 'Použité technologie',
    volunteer: 'Dobrovolnictví',
    add_volunteer: 'Přidat dobrovolnickou zkušenost',
    volunteer_org: 'Organizace',
    volunteer_role: 'Role',
    custom_section: 'Vlastní sekce',
    add_custom_section: 'Přidat vlastní sekci',
    custom_section_title: 'Nadpis sekce',
    custom_entry_title: 'Nadpis',
    custom_entry_subtitle: 'Podnázev',
    custom_entry_date: 'Datum',
    custom_entry_desc: 'Popis',
    add_custom_entry: 'Přidat záznam',
    saved_indicator: 'Uloženo',
    preview_cv: 'Náhled CV',
    tpl_executive: 'Vedoucí',
    tpl_creative: 'Kreativní',
    tpl_technical: 'Technický',
    tpl_minimal: 'Minimální',
    tpl_academic: 'Akademický',
    tpl_infographic: 'Infografika',
    tpl_elegant: 'Elegantní',
    tpl_twopage: 'Dvě stránky',
    publications: 'Publikace',
    add_publication: 'Přidat publikaci',
    pub_title: 'Nadpis',
    pub_authors: 'Autoři',
    pub_venue: 'Časopis / Konference',
    pub_date: 'Datum',
    pub_url: 'URL',
    references: 'Reference',
    add_reference: 'Přidat referenci',
    ref_name: 'Jméno',
    ref_title: 'Titul / Pozice',
    ref_company: 'Společnost',
    ref_email: 'Email',
    ref_phone: 'Telefon',
    references_available: 'Reference k dispozici na vyžádání',
    ats_checker: 'ATS skóre',
    ats_paste_job: 'Vložte popis pozice sem',
    ats_analyze: 'Analyzovat',
    ats_score: 'Skóre',
    ats_suggestions: 'Návrhy',
    ats_matched: 'Nalezená klíčová slova',
    ats_missing: 'Chybějící klíčová slova',
    ats_add_keywords: 'Přidejte tato klíčová slova do CV',
    ats_add_section: 'Přidejte nebo doplňte sekci',
    ats_sec_summary: 'Profesionální shrnutí',
    ats_sec_experience: 'Pracovní zkušenosti',
    ats_sec_skills: 'Dovednosti',
    ats_sec_education: 'Vzdělání',
    ats_sec_header: 'Jméno a pozice',
    ats_fmt_chars: 'Odstraňte speciální znaky — ATS je nemusí přečíst',
    ats_fmt_date: 'Použijte konzistentní formát data (YYYY-MM)',
    ats_fmt_summary_long: 'Zkraťte shrnutí (max. 500 znaků)',
    ats_fmt_summary_short: 'Rozšiřte shrnutí (min. 30 znaků)',
    ats_fmt_bullet: 'Zkraťte odrážky (max. 200 znaků)',
    ats_fmt_few: 'Přidejte více odrážek ke zkušenostem',
    ats_fmt_contact: 'Přidejte email nebo telefonní číslo',
    content_helpers: 'Pomoc s psaním',
    action_verbs: 'Akční slovesa',
    bullet_templates: 'Šablony odrážek',
    weak_words_detected: 'Slabá slova nalezena',
    download_docx: 'Stáhnout DOCX',
    drag_hint: 'Přetáhněte pro přeskupení',
  ...
  el: {
    ...
    step_exp: 'Εμπειρία',
    step_edu: 'Εκπαίδευση',
    step_skills: 'Δεξιότητες',
    step_extras: 'Επιπλέον',
    full_name: 'Πλήρες όνομα *',
    job_title: 'Τίτλος / Θέση *',
    summary: 'Περίληψη',
    phone: 'Τηλέφωνο',
    city: 'Πόλη / Χώρα',
    website: 'Ιστότοπος',
    ...
    add_experience: 'Προσθήκη εμπειρίας',
    add_education: 'Προσθήκη εκπαίδευσης',
    add_skill_group: 'Προσθήκη κατηγορίας',
    add_certification: 'Προσθήκη',
    ...
    design_options: 'Σχεδιασμός & Επιλογές',
    template: 'Πρότυπο',
    tpl_modern: 'Μοντέρνο',
    tpl_classic: 'Κλασικό',
    tpl_bold: 'Έντονο',
    tpl_compact: 'Συμπαγές',
    accent_color: 'Χρώμα τόνου',
    font: 'Γραμματοσειρά',
    ...
    share: 'Κοινοποίηση',
    download: 'Λήψη PDF',
    save_json: 'Αποθήκευση',
    import_json: 'Εισαγωγή',
    saved_json: 'CV αποθηκεύτηκε ✓',
    imported_json: 'CV εισήχθη ✓',
    import_error: 'Μη έγκυρο αρχείο',
    persist_tip: 'Αποθηκεύστε το βιογραφικό σας σε JSON για να το ανακτήσετε αργότερα.',
    history_empty: 'Κανένα βιογραφικό στο ιστορικό',
    share_title: 'Κοινοποίηση βιογραφικού',
    share_desc: 'Αυτός ο σύνδεσμος περιέχει όλα τα δεδομένα σας. Κανένα δεδομένο δεν αποστέλλεται σε διακομιστή.',
    copy_link: 'Αντιγραφή',
    link_copied: '✓ Σύνδεσμος αντιγράφηκε!',
    preview_placeholder: 'Συμπληρώστε τη φόρμα για να δείτε το βιογραφικό σας',
    ...
    description: 'Περιγραφή / Βασικά σημεία (ένα ανά γραμμή)',
    school: 'Σχολείο / Πανεπιστήμιο',
    degree: 'Πτυχίο',
    field: 'Τομέας σπουδών',
    grade: 'Βαθμός',
    skill_category: 'Κατηγορία (π.χ. Γλώσσες, Εργαλεία…)',
    skill_items: 'Δεξιότητες (διαχωρισμένες με κόμμα)',
    cert_name: 'Όνομα πιστοποιητικού',
    cert_issuer: 'Εκδότης',
    cert_date: 'Ημερομηνία',
    lang_name: 'Γλώσσα',
    lang_level: 'Επίπεδο (π.χ. Μητρική, B2)',
    load: 'Φόρτωση',
    duplicate: 'Αντιγραφή',
    delete: 'Διαγραφή',
    pdf_generating: 'Δημιουργία PDF…',
    pdf_done: 'PDF λήφθηκε!',
    present: 'Παρόν',
    unnamed: 'Χωρίς τίτλο',
    demo_title: 'Δείγμα δεδομένων',
    demo_desc: 'αντικαταστήστε με τα δικά σας',
    demo_clear: 'Εκκαθάριση όλων',
    projects: 'Έργα',
    add_project: 'Προσθήκη έργου',
    project_name: 'Όνομα έργου',
    project_description: 'Περιγραφή',
    project_url: 'URL έργου',
    project_tech: 'Χρησιμοποιούμενες τεχνολογίες',
    volunteer: 'Εθελοντισμός',
    add_volunteer: 'Προσθήκη εθελοντικής εμπειρίας',
    volunteer_org: 'Οργανισμός',
    volunteer_role: 'Ρόλος',
    custom_section: 'Προσαρμοσμένη ενότητα',
    add_custom_section: 'Προσθήκη προσαρμοσμένης ενότητας',
    custom_section_title: 'Τίτλος ενότητας',
    custom_entry_title: 'Τίτλος',
    custom_entry_subtitle: 'Υπότιτλος',
    custom_entry_date: 'Ημερομηνία',
    custom_entry_desc: 'Περιγραφή',
    add_custom_entry: 'Προσθήκη εγγραφής',
    saved_indicator: 'Αποθηκεύτηκε',
    preview_cv: 'Προεπισκόπηση βιογραφικού',
    tpl_executive: 'Εκτελεστικό',
    tpl_creative: 'Δημιουργικό',
    tpl_technical: 'Τεχνικό',
    tpl_minimal: 'Μινιμαλιστικό',
    tpl_academic: 'Ακαδημαϊκό',
    tpl_infographic: 'Infographic',
    tpl_elegant: 'Κομψό',
    tpl_twopage: 'Δύο σελίδες',
    publications: 'Δημοσιεύσεις',
    add_publication: 'Προσθήκη δημοσίευσης',
    pub_title: 'Τίτλος',
    pub_authors: 'Συγγραφείς',
    pub_venue: 'Περιοδικό / Συνέδριο',
    pub_date: 'Ημερομηνία',
    pub_url: 'URL',
    references: 'Συστάσεις',
    add_reference: 'Προσθήκη σύστασης',
    ref_name: 'Όνομα',
    ref_title: 'Τίτλος / Θέση',
    ref_company: 'Εταιρεία',
    ref_email: 'Email',
    ref_phone: 'Τηλέφωνο',
    references_available: 'Συστάσεις διαθέσιμες κατόπιν αιτήματος',
    ats_checker: 'Βαθμολογία ATS',
    ats_paste_job: 'Επικολλήστε την περιγραφή θέσης εδώ',
    ats_analyze: 'Ανάλυση',
    ats_score: 'Βαθμολογία',
    ats_suggestions: 'Προτάσεις',
    ats_matched: 'Λέξεις-κλειδιά που βρέθηκαν',
    ats_missing: 'Λέξεις-κλειδιά που λείπουν',
    ats_add_keywords: 'Προσθέστε αυτές τις λέξεις-κλειδιά στο βιογραφικό σας',
    ats_add_section: 'Προσθέστε ή συμπληρώστε την ενότητα',
    ats_sec_summary: 'Επαγγελματική περίληψη',
    ats_sec_experience: 'Επαγγελματική εμπειρία',
    ats_sec_skills: 'Δεξιότητες',
    ats_sec_education: 'Εκπαίδευση',
    ats_sec_header: 'Όνομα και τίτλος',
    ats_fmt_chars: 'Αφαιρέστε ειδικούς χαρακτήρες — το ATS μπορεί να μην τους διαβάσει',
    ats_fmt_date: 'Χρησιμοποιήστε συνεπή μορφή ημερομηνίας (YYYY-MM)',
    ats_fmt_summary_long: 'Συντομεύστε την περίληψη (μέγ. 500 χαρακτήρες)',
    ats_fmt_summary_short: 'Επεκτείνετε την περίληψη (ελάχ. 30 χαρακτήρες)',
    ats_fmt_bullet: 'Συντομεύστε τα σημεία (μέγ. 200 χαρακτήρες)',
    ats_fmt_few: 'Προσθέστε περισσότερα σημεία στην εμπειρία σας',
    ats_fmt_contact: 'Προσθέστε email ή αριθμό τηλεφώνου',
    content_helpers: 'Βοήθεια συγγραφής',
    action_verbs: 'Ρήματα δράσης',
    bullet_templates: 'Πρότυπα σημείων',
    weak_words_detected: 'Εντοπίστηκαν αδύναμες λέξεις',
    download_docx: 'Λήψη DOCX',
    drag_hint: 'Σύρετε για αναδιάταξη',
    font_size: 'Μέγεθος γραμματοσειράς',
    spacing: 'Διάστιχο',
    sidebar_width: 'Πλάτος πλαϊνής γραμμής',
...
const LANGS = [
  ...
  { code: 'no', label: 'Norsk', flag: flagImg('no','NO') },
